...
Client.prototype.callWallet = function(method, params, callback, errback, path) {
  this.walletCommand = true;
  this.call(method, params, callback, errback, path); 
}
...
Client.prototype.call = function(method, params, callback, errback, path) {
  ...
  var port = (this.opts.dcrWalletPort && this.opts.dcrdPort) ? this.walletCommand ? 
    this.opts.dcrWalletPort : this.opts.dcrdPort : this.opts.port;
  var requestOptions = {
    host: this.opts.host,
    port: port,
    method: 'POST',
  ...
  if (!this.opts.user || !this.opts.pass) {
    return errback("Need parameter user and pass");
  }
